...
{
    TfType::Define<MjcPhysicsSiteAPI,
...
/* static */
MjcPhysicsSiteAPI
MjcPhysicsSiteAPI::Get(const UsdStagePtr &stage, const SdfPath &path)
{
    if (!stage) {
...
/* static */
MjcPhysicsSiteAPI
MjcPhysicsSiteAPI::Apply(const UsdPrim &prim)
{
...
/* static */
const TfType &
MjcPhysicsSiteAPI::_GetStaticTfType()
{
...
/* static */
bool 
MjcPhysicsSiteAPI::_IsTypedSchema()
{
...
/* virtual */
const TfType &
MjcPhysicsSiteAPI::_GetTfType() const
{
    return _GetStaticTfType();
}

UsdAttribute
MjcPhysicsSiteAPI::GetGroupAttr() const
{
    return GetPrim().GetAttribute(MjcPhysicsTokens->mjcGroup);
}

UsdAttribute
MjcPhysicsSiteAPI::CreateGroupAttr(VtValue const &defaultValue, bool writeSparsely) const
{
...
/*static*/
const TfTokenVector&
MjcPhysicsSiteAPI::GetSchemaAttributeNames(bool includeInherited)
{
