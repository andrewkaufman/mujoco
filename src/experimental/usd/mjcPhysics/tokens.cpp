...
MjcPhysicsTokensType::MjcPhysicsTokensType() :
    ...
    mjcCompilerBalanceInertia("mjc:compiler:balanceInertia", TfToken::Immortal),
    ...
    mjcCompilerInertiaFromGeom("mjc:compiler:inertiaFromGeom", TfToken::Immortal),
    mjcCompilerInertiaGroupRangeMax("mjc:compiler:inertiaGroupRange:max", TfToken::Immortal),
    mjcCompilerInertiaGroupRangeMin("mjc:compiler:inertiaGroupRange:min", TfToken::Immortal),
    ...
    mjcOptionActuatorgroupdisable("mjc:option:actuatorgroupdisable", TfToken::Immortal),
    ...
    mjcOptionNoslip_iterations("mjc:option:noslip_iterations", TfToken::Immortal),
    mjcOptionNoslip_tolerance("mjc:option:noslip_tolerance", TfToken::Immortal),
