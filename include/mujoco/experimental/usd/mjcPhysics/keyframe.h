...
public:
    ...
    MJCPHYSICS_API
    UsdAttribute CreateMjcQposAttr(VtValue const &defaultValue = VtValue(), bool writeSparsely=false) const;
...
public:
    ...
    /// the default for \p writeSparsely is \c false.
    MJCPHYSICS_API
    UsdAttribute CreateMjcQvelAttr(VtValue const &defaultValue = VtValue(), bool writeSparsely=false) const;
...
public:
    ...
    /// the default for \p writeSparsely is \c false.
    MJCPHYSICS_API
    UsdAttribute CreateMjcActAttr(VtValue const &defaultValue = VtValue(), bool writeSparsely=false) const;
...
public:
    ...
    /// the default for \p writeSparsely is \c false.
    MJCPHYSICS_API
    UsdAttribute CreateMjcCtrlAttr(VtValue const &defaultValue = VtValue(), bool writeSparsely=false) const;
...
public:
    ...
    /// the default for \p writeSparsely is \c false.
    MJCPHYSICS_API
    UsdAttribute CreateMjcMposAttr(VtValue const &defaultValue = VtValue(), bool writeSparsely=false) const;
...
public:
    ...
    /// the default for \p writeSparsely is \c false.
    MJCPHYSICS_API
    UsdAttribute CreateMjcMquatAttr(VtValue const &defaultValue = VtValue(), bool writeSparsely=false) const;
