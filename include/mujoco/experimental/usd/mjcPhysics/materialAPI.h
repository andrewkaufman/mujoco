...
public:
    ...
    MJCPHYSICS_API
    UsdAttribute CreateTorsionalFrictionAttr(VtValue const &defaultValue = VtValue(), bool writeSparsely=false) const;
...
public:
    ...
    /// the default for \p writeSparsely is \c false.
    MJCPHYSICS_API
    UsdAttribute CreateRollingFrictionAttr(VtValue const &defaultValue = VtValue(), bool writeSparsely=false) const;
