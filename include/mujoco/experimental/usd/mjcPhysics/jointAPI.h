...
public:
    ...
    /// the default for \p writeSparsely is \c false.
    MJCPHYSICS_API
    UsdAttribute CreateMjcSpringdamperAttr(VtValue const &defaultValue = VtValue(), bool writeSparsely=false) const;
...
public:
    ...
    /// the default for \p writeSparsely is \c false.
    MJCPHYSICS_API
    UsdAttribute CreateMjcSolreflimitAttr(VtValue const &defaultValue = VtValue(), bool writeSparsely=false) const;
...
public:
    ...
    /// the default for \p writeSparsely is \c false.
    MJCPHYSICS_API
    UsdAttribute CreateMjcSolimplimitAttr(VtValue const &defaultValue = VtValue(), bool writeSparsely=false) const;
...
public:
    ...
    /// the default for \p writeSparsely is \c false.
    MJCPHYSICS_API
    UsdAttribute CreateMjcSolreffrictionAttr(VtValue const &defaultValue = VtValue(), bool writeSparsely=false) const;
...
public:
    ...
    /// the default for \p writeSparsely is \c false.
    MJCPHYSICS_API
    UsdAttribute CreateMjcSolimpfrictionAttr(VtValue const &defaultValue = VtValue(), bool writeSparsely=false) const;
...
public:
    ...
    /// the default for \p writeSparsely is \c false.
    MJCPHYSICS_API
    UsdAttribute CreateMjcStiffnessAttr(VtValue const &defaultValue = VtValue(), bool writeSparsely=false) const;
...
public:
    ...
    /// the default for \p writeSparsely is \c false.
    MJCPHYSICS_API
    UsdAttribute CreateMjcActuatorfrcrangeMinAttr(VtValue const &defaultValue = VtValue(), bool writeSparsely=false) const;

public:
    // --------------------------------------------------------------------- //
    // MJCACTUATORFRCRANGEMAX 
    // --------------------------------------------------------------------- //
    /// Maximum range for clamping total actuator forces acting on this joint. See Force limits for details. It is available only for scalar joints (hinge and slider) and ignored for ball and free joints. The compiler expects the first value to be smaller than the second value. Setting this attribute without specifying actuatorfrclimited is an error if compiler-autolimits is 'false'.
    ///
    /// | ||
    /// | -- | -- |
    ...
    /// the default for \p writeSparsely is \c false.
    MJCPHYSICS_API
    UsdAttribute CreateMjcActuatorfrcrangeMaxAttr(VtValue const &defaultValue = VtValue(), bool writeSparsely=false) const;
...
public:
    ...
    /// the default for \p writeSparsely is \c false.
    MJCPHYSICS_API
    UsdAttribute CreateMjcActuatorfrclimitedAttr(VtValue const &defaultValue = VtValue(), bool writeSparsely=false) const;
...
public:
    ...
    /// the default for \p writeSparsely is \c false.
    MJCPHYSICS_API
    UsdAttribute CreateMjcActuatorgravcompAttr(VtValue const &defaultValue = VtValue(), bool writeSparsely=false) const;
...
public:
    ...
    /// the default for \p writeSparsely is \c false.
    MJCPHYSICS_API
    UsdAttribute CreateMjcMarginAttr(VtValue const &defaultValue = VtValue(), bool writeSparsely=false) const;
...
public:
    ...
    /// the default for \p writeSparsely is \c false.
    MJCPHYSICS_API
    UsdAttribute CreateMjcRefAttr(VtValue const &defaultValue = VtValue(), bool writeSparsely=false) const;
...
public:
    ...
    /// the default for \p writeSparsely is \c false.
    MJCPHYSICS_API
    UsdAttribute CreateMjcSpringrefAttr(VtValue const &defaultValue = VtValue(), bool writeSparsely=false) const;
...
public:
    ...
    /// the default for \p writeSparsely is \c false.
    MJCPHYSICS_API
    UsdAttribute CreateMjcArmatureAttr(VtValue const &defaultValue = VtValue(), bool writeSparsely=false) const;
...
public:
    ...
    /// the default for \p writeSparsely is \c false.
    MJCPHYSICS_API
    UsdAttribute CreateMjcDampingAttr(VtValue const &defaultValue = VtValue(), bool writeSparsely=false) const;
...
public:
    ...
    /// the default for \p writeSparsely is \c false.
    MJCPHYSICS_API
    UsdAttribute CreateMjcFrictionlossAttr(VtValue const &defaultValue = VtValue(), bool writeSparsely=false) const;
