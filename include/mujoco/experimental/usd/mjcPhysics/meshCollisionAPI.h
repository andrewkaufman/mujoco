...
public:
    ...
    /// Equivalent to MjcPhysicsMeshCollisionAPI::Get(prim.GetStage(), prim.GetPath())
    ...
    ///
    MJCPHYSICS_API
    static MjcPhysicsMeshCollisionAPI
    ...
    /// 
    /// \return A valid MjcPhysicsMeshCollisionAPI object is returned upon success. 
    /// An invalid (or empty) MjcPhysicsMeshCollisionAPI object is returned upon 
...
public:
    ...
    MJCPHYSICS_API
    UsdAttribute CreateInertiaAttr(VtValue const &defaultValue = VtValue(), bool writeSparsely=false) const;
...
public:
    ...
    /// the default for \p writeSparsely is \c false.
    MJCPHYSICS_API
    UsdAttribute CreateMaxHullVertAttr(VtValue const &defaultValue = VtValue(), bool writeSparsely=false) const;
