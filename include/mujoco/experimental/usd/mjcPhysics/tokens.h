...
struct MjcPhysicsTokensType {
    ...
    /// \brief "affine"
    /// 
    /// Possible value for MjcPhysicsActuator::GetMjcBiasTypeAttr(), Possible value for MjcPhysicsActuator::GetMjcGainTypeAttr()
    const TfToken affine;
    /// \brief "auto"
    /// 
    /// Fallback value for MjcPhysicsSceneAPI::GetInertiaFromGeomAttr(), Fallback value for MjcPhysicsSceneAPI::GetJacobianAttr(), Fallback value for MjcPhysicsActuator::GetMjcActLimitedAttr(), Fallback value for MjcPhysicsActuator::GetMjcCtrlLimitedAttr(), Fallback value for MjcPhysicsActuator::GetMjcForceLimitedAttr(), Fallback value for MjcPhysicsJointAPI::GetMjcActuatorfrclimitedAttr(), Fallback value for MjcPhysicsTendon::GetActuatorFrcLimitedAttr(), Fallback value for MjcPhysicsTendon::GetLimitedAttr(),  This token represents the auto constraint Jacobian and matrices computed from it. 
    const TfToken auto_;
    /// \brief "cg"
    /// 
    /// Possible value for MjcPhysicsSceneAPI::GetSolverAttr(),  This token represents the CG constraint solver algorithm. 
    const TfToken cg;
    /// \brief "convex"
    /// 
    ...
    /// \brief "dense"
    /// 
    /// Possible value for MjcPhysicsSceneAPI::GetJacobianAttr(),  This token represents the dense constraint Jacobian and matrices computed from it. 
    const TfToken dense;
    /// \brief "elliptic"
    /// 
    /// Possible value for MjcPhysicsSceneAPI::GetConeAttr(),  This token represents the elliptic contact friction cone type. 
    const TfToken elliptic;
    /// \brief "euler"
    /// 
    /// Fallback value for MjcPhysicsSceneAPI::GetIntegratorAttr(),  This token represents the Euler numerical integrator. 
    const TfToken euler;
    /// \brief "exact"
    /// 
    /// Possible value for MjcPhysicsMeshCollisionAPI::GetInertiaAttr()
    ...
    /// \brief "false"
    /// 
    /// Possible value for MjcPhysicsSceneAPI::GetInertiaFromGeomAttr(), Possible value for MjcPhysicsActuator::GetMjcActLimitedAttr(), Possible value for MjcPhysicsActuator::GetMjcCtrlLimitedAttr(), Possible value for MjcPhysicsActuator::GetMjcForceLimitedAttr(), Possible value for MjcPhysicsJointAPI::GetMjcActuatorfrclimitedAttr(), Possible value for MjcPhysicsTendon::GetActuatorFrcLimitedAttr(), Possible value for MjcPhysicsTendon::GetLimitedAttr()
    ...
    /// \brief "fixed"
    /// 
    /// Fallback value for MjcPhysicsActuator::GetMjcGainTypeAttr(), Possible value for MjcPhysicsTendon::GetTypeAttr()
    const TfToken fixed;
    /// \brief "implicit"
    /// 
    /// Possible value for MjcPhysicsSceneAPI::GetIntegratorAttr(),  This token represents the implicit numerical integrator. 
    const TfToken implicit;
    /// \brief "implicitfast"
    /// 
    /// Possible value for MjcPhysicsSceneAPI::GetIntegratorAttr(),  This token represents the implicitfast numerical integrator. 
    ...
    /// \brief "mjc:group"
    /// 
    /// MjcPhysicsSiteAPI, MjcPhysicsImageableAPI, MjcPhysicsCollisionAPI, MjcPhysicsActuator, MjcPhysicsJointAPI, MjcPhysicsTendon
    ...
    /// \brief "muscle"
    /// 
    /// Possible value for MjcPhysicsActuator::GetMjcBiasTypeAttr(), Possible value for MjcPhysicsActuator::GetMjcDynTypeAttr(), Possible value for MjcPhysicsActuator::GetMjcGainTypeAttr()
    const TfToken muscle;
    /// \brief "newton"
    /// 
    /// Fallback value for MjcPhysicsSceneAPI::GetSolverAttr(),  This token represents the Newton constraint solver algorithm. 
    const TfToken newton;
    /// \brief "none"
    /// 
    /// Fallback value for MjcPhysicsActuator::GetMjcBiasTypeAttr(), Fallback value for MjcPhysicsActuator::GetMjcDynTypeAttr()
    const TfToken none;
    /// \brief "pgs"
    /// 
    /// Possible value for MjcPhysicsSceneAPI::GetSolverAttr(),  This token represents the PGS constraint solver algorithm. 
    const TfToken pgs;
    /// \brief "pyramidal"
    /// 
    /// Fallback value for MjcPhysicsSceneAPI::GetConeAttr(),  This token represents the pyramidal contact friction cone type. 
    ...
    /// \brief "rk4"
    /// 
    /// Possible value for MjcPhysicsSceneAPI::GetIntegratorAttr(),  This token represents the RK4 numerical integrator. 
    const TfToken rk4;
    /// \brief "shell"
    /// 
    /// Possible value for MjcPhysicsMeshCollisionAPI::GetInertiaAttr()
    ...
    /// \brief "sparse"
    /// 
    /// Possible value for MjcPhysicsSceneAPI::GetJacobianAttr(),  This token represents the sparse constraint Jacobian and matrices computed from it. 
    ...
    /// \brief "MjcActuator"
    /// 
    /// Schema identifer and family for MjcPhysicsActuator
    ...
    /// 
    /// Schema identifer and family for MjcPhysicsImageableAPI
    const TfToken MjcImageableAPI;
    /// \brief "MjcJointAPI"
    /// 
    /// Schema identifer and family for MjcPhysicsJointAPI
    const TfToken MjcJointAPI;
    /// \brief "MjcKeyframe"
    /// 
    /// Schema identifer and family for MjcPhysicsKeyframe
    const TfToken MjcKeyframe;
    /// \brief "MjcMaterialAPI"
    /// 
    /// Schema identifer and family for MjcPhysicsMaterialAPI
    ...
    /// \brief "MjcTendon"
    /// 
    /// Schema identifer and family for MjcPhysicsTendon
